...
public class HttpUtils {
     ...
     * @return
     */
    public static String sendGetByToken(String url, String param, String authorization){
        return sendGet(url, param, "UTF-8", authorization);
    }
     ...
     * @return
     */
    public static String sendPostByToken(String url, String param, String authorization){
        return sendPost(url, param, authorization);
    }
